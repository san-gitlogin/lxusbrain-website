        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              ...
              >
                ...
                {DOWNLOADS_AVAILABLE ? (
                  <a
                    href="https://github.com/LxusBrain/termivoxed/releases/download/v1.0.5/TermiVoxed-1.0.5-Setup.exe"
                ...
                <p className="text-center text-xs text-muted-foreground mt-2">v1.0.5 • 85 MB</p>
              </div>
              ...
              >
                ...
                {DOWNLOADS_AVAILABLE ? (
                  <a
                    href="https://github.com/LxusBrain/termivoxed/releases/download/v1.0.5/TermiVoxed-1.0.5-macos.dmg"
                ...
                <p className="text-center text-xs text-muted-foreground mt-2">v1.0.5 • 92 MB</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {DOWNLOADS_AVAILABLE ? (
                <a
                  href="https://github.com/LxusBrain/termivoxed/releases/tag/v1.0.5"

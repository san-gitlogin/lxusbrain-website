...
export function MagneticText({
  ...
  return (
    ...
    >
      ...
      <span className={cn(
        "text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight text-foreground",
        textClassName
      )}>
        {text}
      </span>
      ...
      >
        ...
        >
          <span className={cn(
            "text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight text-background whitespace-nowrap",

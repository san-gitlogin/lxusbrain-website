...
exports.exportUserData = exports.deleteAccount = exports.getSubscriptionStatus = exports.cancelSubscription = exports.createSubscription = exports.razorpayWebhook = exports.verifyPayment = exports.createOrder = void 0;
...
function getRazorpay() {
    if (!razorpayInstance) {
        ...
        razorpayInstance = new Razorpay({
            key_id: config_1.razorpayConfig.key_id,
            key_secret: config_1.razorpayConfig.key_secret,
        });
    }
    ...
    corsHandler(req, res, async () => {
        ...
        try {
            ...
            res.json({
                ...
                amount: pricing.amount,
                currency: pricing.currency,
                keyId: config_1.razorpayConfig.key_id,
            });
        }
        catch (error) {
...
exports.verifyPayment = functions.https.onRequest((req, res) => {
    corsHandler(req, res, async () => {
        ...
        try {
            ...
            const billingPeriod = orderData.billingPeriod;
            const plan = config_1.PLANS[planId];
...
exports.razorpayWebhook = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        const expectedSignature = crypto
            .createHmac('sha256', config_1.razorpayConfig.webhook_secret)
            .update(rawBody)
            .digest('hex');
 ...
 */
exports.exportUserData = functions.https.onRequest((req, res) => {
    corsHandler(req, res, async () => {
        if (req.method !== 'GET') {
            res.status(405).json({ success: false, error: 'Method not allowed' });
            return;
